...
before-all::
	@if [[ ! -f $(UYOU_DEB) ]]; then \
		curl -s "https://www.dropbox.com/scl/fi/zi3crkm96bxit94p1fqw5/com.miro.uyou_3.0.3_iphoneos-arm.deb?rlkey=4zx2nvbb1k3isal22ptvdxtvb&st=7ey0gh9o&dl=1" -o $(UYOU_DEB); \
 	fi; \
